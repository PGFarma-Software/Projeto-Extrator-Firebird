...
import polars as pl
import pytz
from fdb import Connection, OperationalError
...
def conectar_ao_banco(host: str, port: int, database: str, user: str, password: str) -> Connection:
    ...
    Returns:
        fdb.Connection: Objeto de conexão ao banco de dados.
    """
    try:
        ...
        conexao = fdb.connect(
            ...
            user=user,
            password=password,
            charset="latin1"  # Define o charset para evitar problemas de encoding
        )
